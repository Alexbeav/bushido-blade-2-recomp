...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Bushido Blade 2",
    .project_root_env = "BUSHIDO_BLADE_2_PROJECT_ROOT",
    .build_dir_env = "BUSHIDO_BLADE_2_BUILD_DIR",
    .force_setup_env = "BUSHIDO_BLADE_2_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/slus_006.63_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Bushido_Blade_2",
    .prepare_note =
